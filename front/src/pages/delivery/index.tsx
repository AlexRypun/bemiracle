    ...
    <div className="delivery-page">
      ...
      <div className="text-block">
        ...
        <p className="desc">
          ...
          yourself. To be brave and grab life as the extraordinary adventure it is. So we make sure everyone has an
          equal chance to discover all the amazing things they’re capable of – no matter who they are, where they’re
